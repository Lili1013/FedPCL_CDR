...
def parse():
    ...
    # parser.add_argument('--disen_embed_dim', type=int, default=32, metavar='N', help='disen feature embedding size')
    ...
    #                     metavar='N', help='the clients')
    # parser.add_argument('--client_names', type=list,
    #                     default=['douban_book_music_book', 'douban_book_music_music'],
    #                     metavar='N', help='the clients')
    parser.add_argument('--client_names', type=list,
