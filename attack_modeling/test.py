...
from models.kmeans_ldp import k_means,spectral_cluster,k_means_analysis
...
def local_model_update(args, P, C, model, local_data,optimizer,device,round_number,client_number,cat_labels):
    ...
    samples_per_cluster,variances_per_cluster = k_means_analysis(num_clusters=args.num_clusters, embeddings=u_feats)
    print(samples_per_cluster)
    print(variances_per_cluster)
    print('ggggggggggggggggg')
    # cat_dict,cluster_overlap_smaples,labels = k_means(num_clusters=args.num_clusters,embeddings=u_common_feats,overlap_users=overlap_users)
        ...
        for cat, cat_value in client_value.items():
            ...
            if client_num == 3:
                ...
                for each_cat in client_2_cats:
                    P_all[client][cat].append(P[2][each_cat][0])
...
def get_rep_proto():
    ...
    logger.info(f'parameter settings: batch_size:{args.batch_size},lr:{args.lr},embed_id_dim:{args.embed_id_dim},'
                f'review_emb_dim:{args.review_embed_dim},alpha:{args.alpha},tau:{args.tau}, client_num:{args.client_num},'
                f'client_names:{args.client_names},num_clusters:{args.num_clusters},'
                f'disen_feat_agg_way:{args.disen_feat_agg_way},global_proto_agg_way:{args.global_proto_agg_way},top_k:{args.top_k},local epochs:{args.epochs}')
    ...
    # with open('../best_models_02_23/amazon/sport_emb_64_rev_emb_64_c_10_alpha_0.01_beta_0.1_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_29.model')
    # best_model_list = [
    #     '../best_models_02_23/amazon/phone_emb_64_rev_emb_64_c_30_alpha_0.1_beta_0.1_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_28.model',
    #     '../best_models_02_23/amazon/sport_emb_64_rev_emb_64_c_30_alpha_0.1_beta_0.1_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_28.model']
    best_model_list = ['../best_models_02_23/douban_two_domains/douban_movie_music_movie_emb_64_rev_emb_64_c_20_alpha_0.01_tau_0.2_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_30.model',
    '../best_models_02_23/douban_two_domains/douban_movie_music_music_emb_64_rev_emb_64_c_20_alpha_0.01_tau_0.2_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_30.model']
    ...
    for j in range(args.client_num):
        ...
        client_P = local_model_update(args=args,
                                      P=P_new[j], C=C_new[j], model=local_model_list[j],
...
if __name__ == '__main__':
    ...
    # with open('../best_models_02_23/amazon/sport_emb_64_rev_emb_64_c_10_alpha_0.01_beta_0.1_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_29.model')
    best_model_list = [
        '../best_models_02_23/amazon/phone_emb_64_rev_emb_64_c_10_alpha_0.01_beta_0.1_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_29.model',
        '../best_models_02_23/amazon/sport_emb_64_rev_emb_64_c_10_alpha_0.01_beta_0.1_lr_0.001_b_128__disen_way_sum_global_proto_agg_way_avg_k_10_epoch_1_3_29.model']
    logger.info('initialize local data and local model:{}',args.client_names)
    for j in range(args.client_num):
        data_params[args.client_names[j]].update({'args': args})
        local_data = Load_Data(**data_params[args.client_names[j]])
        ...
        # logger.info(client_name)
        local_model = Local_Model(**model_params[client_name])
        pretrain_dict = torch.load(f'{best_model_list[j]}')  # update net parameters
        para_dict = local_model.state_dict()
        same_para_dict = {k: v for k, v in pretrain_dict.items() if k in para_dict}
        para_dict.update(same_para_dict)
        local_model.load_state_dict(para_dict)
